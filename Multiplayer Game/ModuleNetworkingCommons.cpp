...
{
	MouseController mousepad = previousGamepad;
	mousepad.x = inputPacketData.mouseX;
	mousepad.y = inputPacketData.mouseY;
	unpackMouseControllerButtons(inputPacketData.mouseButtonBits, mousepad);
	return mousepad;
}
